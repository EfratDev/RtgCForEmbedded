...
int find_longest_ascending_subarray(int * array, size_t size) {
    int max = 0, max_i = NO_SUCH, counter = 0;
...
int main() {
    ...
    int i = find_longest_ascending_subarray(array, size);
    if (i != NO_SUCH) {
        printf("The longest ascending subarray is starting at %d.\n", i);
    } else {
